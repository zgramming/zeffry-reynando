    ...
    <>
      <div className={`${styled.layout_container} px-5`}>
        ...
        <div className={`${styled.description}`}>
          ...
          Starting from here, I like to make applications that can solve
          problems in the surrounding environment. With experience in making
          mobile applications using <span className="fw-bold">Flutter</span>{" "}
          accompanied by website development using&nbsp;
